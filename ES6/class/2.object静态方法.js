...
// Object.is() 比较两个值是否相等，引用类型的对象比较内存地址是否相等
// 比较和 === 大致相同，不同在于：
...
// Object.create({}, [propertiesObject]) 第一个参数可以是空对象、null、对象的prototype
...
// Object.defineProperties(obj, prop) 给对象添加新的属性
let obj = {
    name: 'obj'
  };
...
// Object.keys()
// 返回对象的可枚举属性数组。Object.keys(obj)还会对属性名进行排序
